        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-6 border-x border-black/10 dark:border-stone-700 px-0 lg:px-8 space-y-12">
            ...
            <section>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 border-b border-black/10 dark:border-stone-700 pb-8">
                ...
                <div className="bg-stone-50 dark:bg-stone-800 border border-black/5 dark:border-stone-700 p-4 min-w-[200px] w-full md:w-auto">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-stone-400">
                      Mission Progress
                    </span>
                    <span className="text-xs font-serif font-bold text-[#9DB38A] dark:text-[#9DB38A]">
                      On Track
                    </span>
                  </div>
                  <div className="flex items-end gap-2 mb-2">
                    <span className="text-3xl font-black font-serif leading-none text-black dark:text-stone-100">
                      Lvl 3
                    </span>
                    <span className="text-xs font-serif italic text-gray-500 dark:text-stone-400 mb-1">
                      Scholar
                    </span>
                  </div>
                  ...
                  <p className="text-[10px] uppercase tracking-wide text-gray-400 dark:text-stone-500 mt-2 text-right">
                    65% to Analyst
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12 pt-6 border-t-2 border-black dark:border-stone-600">
                <section>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="bg-black dark:bg-stone-100 p-1.5">
                        <Newspaper className="w-4 h-4 text-white dark:text-stone-900" />
                      </div>
                      <h2 className="font-serif text-2xl font-black uppercase tracking-wide text-black dark:text-stone-100">
                        Top Stories
                      </h2>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                      <span className="text-[10px] uppercase font-bold tracking-widest text-gray-500 dark:text-stone-400">
                        Live
                      </span>
                    </div>
                  </div>
                  ...
                  {loadingNews ? (
                    <div className="py-16 text-center">
                      <div className="inline-flex items-center gap-3">
                        <div className="w-4 h-4 border-2 border-black dark:border-stone-400 border-t-transparent rounded-full animate-spin" />
                        <span className="font-serif text-sm text-gray-500 dark:text-stone-400">
                    ...
                    <div className="py-12 text-center border border-dashed border-gray-300 dark:border-stone-700">
                      <Newspaper className="w-8 h-8 mx-auto mb-3 text-gray-300 dark:text-stone-600" />
                      <p className="font-serif text-sm italic text-gray-500 dark:text-stone-400">
