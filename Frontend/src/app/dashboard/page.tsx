                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        <div className="border-t-4 border-black pt-2">
                            ...
                            {loadingStocks ? (
                                <div className="text-sm font-serif italic text-gray-500">Loading market data...</div>
                            ) : (
                                <PerformersSection performers={performers} className="shadow-none border-t border-black/10" />
                            )}
                        </div>
                    </div>
