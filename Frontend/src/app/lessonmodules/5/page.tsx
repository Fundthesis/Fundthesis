...
const Module5: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-stone-900">
      <ModNav moduleIndex={5} totalModules={10} title="Market Movement & Risk" />
        ...
        <section className="mt-8">
          <div className="bg-white dark:bg-stone-800 rounded-xl shadow-lg p-8">
            ...
            <div style={{ fontFamily: content.layout?.format?.bodyFont }}>
              <Quiz moduleIndex={5} questions={qs} />
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-center mt-4">
          <div className="w-full max-w-3xl grid grid-cols-3 items-center">
            <div className="flex justify-start">
              <a href="/lessonmodules/4" className="px-4 py-2 bg-gray-700 dark:bg-stone-700 text-white rounded hover:bg-gray-600 dark:hover:bg-stone-600 transition-colors">Previous Module</a>
            </div>
            ...
            <div className="flex justify-end">
              <a href="/lessonmodules/6" className="px-4 py-2 bg-gray-700 dark:bg-stone-700 text-white rounded hover:bg-gray-600 dark:hover:bg-stone-600 transition-colors">Next Module</a>
            </div>
          </div>
        </div>
      </main>
