        ...
        <div className="flex justify-center mt-4">
          <div className="w-full max-w-3xl grid grid-cols-3 items-center">
            <div className="flex justify-start">
              <a href="/lessonmodules/4" className="px-4 py-2 bg-gray-700 text-white rounded">Previous Module</a>
            </div>
            ...
            <div className="flex justify-end">
              <a href="/lessonmodules/6" className="px-4 py-2 bg-gray-700 text-white rounded">Next Module</a>
            </div>
          </div>
        </div>
      </main>
