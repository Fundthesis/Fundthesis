        ...
        <div className="flex justify-center mt-4">
          <div className="w-full max-w-3xl grid grid-cols-3 items-center">
            <div className="flex justify-start">
              <a href="/lessonmodules/8" className="px-4 py-2 bg-gray-700 dark:bg-stone-700 text-white rounded hover:bg-gray-600 dark:hover:bg-stone-600 transition-colors">Previous Module</a>
            </div>
            ...
            <div className="flex justify-end">
              <a href="/lessonmodules/10" className="px-4 py-2 bg-gray-700 dark:bg-stone-700 text-white rounded hover:bg-gray-600 dark:hover:bg-stone-600 transition-colors">Next Module</a>
            </div>
          </div>
        </div>
      </main>
