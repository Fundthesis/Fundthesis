      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="border-b-8 border-black dark:border-stone-100 pb-8 mb-12 text-center">
          <div className="flex justify-between items-end mb-4 border-b border-black/20 dark:border-stone-700 pb-2">
            <div className="text-left">
              <p className="text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-stone-400">
                Vol. I, No. 1
              </p>
          ...
          <div className="lg:col-span-8">
            <div className="prose max-w-none dark:prose-invert">
              ...
              <p className="text-2xl leading-relaxed text-gray-800 dark:text-stone-200 mb-8 font-serif">
                <span className="float-left text-7xl font-black mr-4 mt-[-10px] leading-none dark:text-white">
                  F
                </span>
                undThesis isn&apos;t just a platform; it&apos;s a paradigm
                shift. In a world awash with noise, we provide the signal. By
                combining institutional-grade data with next-generation AI, we
                empower the individual investor to compete with the giants.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
                <div className="bg-stone-100 dark:bg-stone-800 p-8 border-t-4 border-black dark:border-green-500">
                  ...
                  <h3 className="text-xl font-bold uppercase tracking-wider mb-2 dark:text-white">
                    Market Insights
                  </h3>
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-stone-300">
                    Real-time analysis of global trends, stripped of jargon and
                ...
                <div className="bg-stone-100 dark:bg-stone-800 p-8 border-t-4 border-black dark:border-green-500">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700 dark:text-stone-300">
                    Your personal portfolio manager, available 24/7 to answer
                    questions and validate theses.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <Link
                href="/discover"
                className="px-8 py-4 bg-white dark:bg-stone-800 text-black dark:text-white border-2 border-black dark:border-stone-600 text-lg font-bold uppercase tracking-widest hover:bg-stone-50 dark:hover:bg-stone-700 transition-colors flex items-center justify-center"
              >
                Explore Markets
              </Link>
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <div className="border border-black dark:border-stone-600 p-1 text-center">
              <div className="border border-black dark:border-stone-600 p-6 bg-stone-50 dark:bg-stone-800">
                ...
                <p className="text-sm uppercase tracking-widest text-gray-500 dark:text-stone-400">
                  Average User Alpha
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-bold uppercase tracking-widest border-b-2 border-black dark:border-stone-600 pb-2 dark:text-white">
                Why FundThesis?
              </h3>

              <div className="group cursor-pointer">
                <h4 className="text-xl font-bold mb-1 group-hover:underline dark:text-white">
                  Environmental Impact
                </h4>
                <p className="text-gray-600 dark:text-stone-400 leading-relaxed">
                  We track the ESG scores that matter, helping you build a
                  sustainable future.
                </p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 dark:text-stone-400 leading-relaxed">
                  Join thousands of disciplined investors sharing wisdom, not
                  hype.
                </p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 dark:text-stone-400 leading-relaxed">
                  Access the same data feeds used by Wall Street, democratized
                  for you.
                </p>
              </div>
            </div>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-4 border-r border-black/10 dark:border-stone-700 last:border-0">
            ...
            <h4 className="font-bold uppercase tracking-widest text-sm dark:text-stone-300">
              Global Data
            </h4>
          </div>
          <div className="p-4 border-r border-black/10 dark:border-stone-700 last:border-0">
